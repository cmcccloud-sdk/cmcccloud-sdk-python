...
<h1 align="center">CMCC Cloud Python Software Development Kit (Python SDK)</h1>

The CMCC Cloud Python SDK allows you to easily work with CMCC Cloud services such as Elastic Compute Service (ECS)
and Virtual Private Cloud (VPC) without the need to handle API related tasks.

This document introduces how to obtain and use CMCC Cloud Python SDK.

## Requirements

- To use CMCC Cloud Python SDK, you must have CMCC Cloud account as well as the Access Key (AK) and Secret key (SK) of the
  CMCC Cloud account. You can create an Access Key in the CMCC Cloud console. 

- To use CMCC Cloud Python SDK to access the APIs of specific service, please make sure you do have activated the
  service in [CMCC Cloud console](https://console.joint.ecloud.10086.cn/) if needed.

- CMCC Cloud Python SDK requires **Python 3.3** or later, run command `python --version` to check the version of Python.
...
Take using VPC SDK for example, you need to install `cmcccloudsdkvpc` library:

- Use python pip

```bash
# Install the VPC management library
pip install cmcccloudsdkvpc
```
...
from cmcccloudsdkcore.auth.credentials import BasicCredentials
from cmcccloudsdkcore.exceptions import exceptions
from cmcccloudsdkcore.http.http_config import HttpConfig

# import specified service library cmcccloudsdk{service}, take vpc for example
from cmcccloudsdkvpc.v2 import *
...
the [CHANGELOG.md](https://github.com/cmcccloud-sdk/cmcccloud-sdk-python/blob/master/CHANGELOG.md).

## User Manual [:top:](#cmcc-cloud-python-software-development-kit-python-sdk)
...
config.proxy_host = 'proxy.cmcccloud.com'
...
- `domain_id` is the account ID of CMCC Cloud.
...
endpoint = "https://vpc.cidc-rp-11.joint.cmecloud.cn"
...
```text
2020-06-16 10:44:02,019 4568 CMCCCloud-SDK http_handler.py 28 INFO "GET https://vpc.cidc-rp-11.joint.cmecloud.cn/v1/0904f9e1f100d2932f94c01f9aa1cfd7/vpcs" 200 11 0:00:00.543430 b5c927ffdab8401e772e70aa49972037
```
...
from cmcccloudsdkservice.v1 import *
